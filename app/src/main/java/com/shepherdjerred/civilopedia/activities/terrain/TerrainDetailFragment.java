 ...
 * This fragment is either contained in a {@link TerrainListActivity}
...
public class TerrainDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.terrain_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.terrain_detail)).setText(mItem.details);
        }
