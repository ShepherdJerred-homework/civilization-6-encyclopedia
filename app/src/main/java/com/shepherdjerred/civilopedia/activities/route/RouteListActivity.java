package com.shepherdjerred.civilopedia.activities.route;
...
import com.shepherdjerred.civilopedia.activities.route.dummy.DummyContent;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(RouteDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(RouteDetailFragment.ARG_ITEM_ID, item.id);
