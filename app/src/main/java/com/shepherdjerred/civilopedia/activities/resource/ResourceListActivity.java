package com.shepherdjerred.civilopedia.activities.resource;
...
import com.shepherdjerred.civilopedia.activities.resource.dummy.DummyContent;
...
public class ResourceListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ResourceDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(ResourceDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(ResourceListActivity parent,
