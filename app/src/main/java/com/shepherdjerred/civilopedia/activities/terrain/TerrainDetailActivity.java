 ...
 * in a {@link TerrainListActivity}.
 */
public class TerrainDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(TerrainDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(TerrainDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, TerrainListActivity.class));
            return true;
        }
